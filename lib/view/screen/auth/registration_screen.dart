...
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:nvc_restaurant_app/view/widgets/custom_snackbar.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AuthController>(builder: (authController) {
      ...
      return WillPopScope(
        ...
        child: Scaffold(
          appBar: CustomAppBar(title: 'Register Your Restaurant', onBackPressed: () => {}),
          body: SafeArea(
            child: Center(child: SizedBox(width: context.width, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(
                    authController.storeStatus == 0.4 ? 'STEP 1- Fill your store information' : 'STEP 2- Fill owner information',
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: authController.pickedCover != null ? GetPlatform.isWeb ? Image.network(
                                      ...
                                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                        ...
                                        Text(
                                          'Select Restaurant Cover Photo'.tr,
                                            style: poppinsMedium.copyWith(color: Theme.of(context).disabledColor,
                                                fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center,
                                        ),
                                      ]),
